...
function build (BIN, THIER_DIRECTORY, project_path) {
  ...
  execSync(`${BIN}/node-sass ${THIER_DIRECTORY}/${project_path}/src/public/scss -o ${THIER_DIRECTORY}/${project_path}/${prod ? 'dist' : 'src'}/public/dist/css ${prod ? '--output-style compressed' : ''}`)
