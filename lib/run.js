...
function test (BIN, THIER_DIRECTORY, project_path) {
  build(BIN, THIER_DIRECTORY, project_path)
  var karma = spawn(`${BIN}/karma`, ['start', `${THIER_DIRECTORY}/${project_path}/config/karma.conf.js`, '--single-run'])
  ...
  var mocha = spawn(`${BIN}/mocha`, [`${THIER_DIRECTORY}/${project_path}/test`])
