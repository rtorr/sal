...
function build (BIN, THEIR_DIRECTORY, project_path) {
  var prod = ENV === 'production'
  execSync(`${BIN}/tsc --project ${THEIR_DIRECTORY}/${project_path}/jsconfig.json`)
  execSync(`${BIN}/webpack --config ${THEIR_DIRECTORY}/${project_path}/config/webpack.config.js ${prod ? '-p' : ''}`)
  execSync(`${BIN}/node-sass ${THEIR_DIRECTORY}/${project_path}/src/public/scss -o ${THEIR_DIRECTORY}/${project_path}/src/public/dist/css ${prod ? '--output-style compressed' : ''}`)
